...
// @ts-ignore
javaGenerator.scrub_ = function processJavaCommandCode(this: Generator, block: Block, code: string, thisOnly?: boolean): string {
...
export function scriptCommandCodeGen(commandData: CommandData, generator: Generator) {
